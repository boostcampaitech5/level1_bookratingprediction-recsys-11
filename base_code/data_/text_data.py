...
def text_data_split_vkfold(args, data, train_idx, validation_idx):
    X_train, y_train =  data['text_train'].loc[train_idx, ['user_id', 'isbn', 'user_summary_merge_vector', 'item_summary_vector']], data['text_train'].loc[train_idx, "rating"]
    X_valid, y_valid =  data['text_train'].loc[validation_idx, ['user_id', 'isbn', 'user_summary_merge_vector', 'item_summary_vector']], data['text_train'].loc[validation_idx, "rating"]
    data['X_train'], data['X_valid'], data['y_train'], data['y_valid'] = X_train, X_valid, y_train, y_valid
    return data

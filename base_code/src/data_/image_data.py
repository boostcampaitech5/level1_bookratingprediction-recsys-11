...
def image_data_split_vkfold(args, data, train_idx, validation_idx):
    X_train, y_train = data['img_train'].loc[train_idx, ['user_id', 'isbn', 'img_vector']], data['img_train'].loc[train_idx, "rating"]
    X_valid, y_valid = data['img_train'].loc[validation_idx, ['user_id', 'isbn', 'img_vector']], data['img_train'].loc[validation_idx, "rating"]
